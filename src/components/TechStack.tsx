              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 py-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {group.pills.map((pill) => (
                    <span
                      key={pill}
                      className="px-3 py-1.5 rounded-lg text-xs text-[#F0F4FF] bg-[#111827] border border-[#1E2D40] cursor-default transition-all duration-200 hover:bg-[#1E2D40] hover:border-[#4FF8E5] hover:text-[#4FF8E5] hover:-translate-y-0.5 hover:[box-shadow:0_0_8px_rgba(79,248,229,0.2)]"
                    >
                      {pill}
                    </span>
                  ))}
